...
ACTION_ANNUAL_REPORT_AMENDED = entity_action(ENTITY_ANNUAL_REPORT, "amended")
ACTION_ANNUAL_REPORT_AMENDMENT_WITHDRAWN = entity_action(
    ENTITY_ANNUAL_REPORT, "amendment_withdrawn"
)
...
ACTION_VAT_WORK_ITEM_AMENDED = entity_action(ENTITY_VAT_WORK_ITEM, "amended")
ACTION_VAT_WORK_ITEM_AMENDMENT_WITHDRAWN = entity_action(
    ENTITY_VAT_WORK_ITEM, "amendment_withdrawn"
)
...
# ---------------------------------------------------------------------------
ACTION_LEGAL_ENTITY_CREATED = entity_action(ENTITY_LEGAL_ENTITY, ACTION_CREATED)
ACTION_LEGAL_ENTITY_UPDATED = entity_action(ENTITY_LEGAL_ENTITY, ACTION_UPDATED)

ACTION_PERSON_CREATED = entity_action(ENTITY_PERSON, ACTION_CREATED)
ACTION_PERSON_UPDATED = entity_action(ENTITY_PERSON, ACTION_UPDATED)

ACTION_PERSON_LEGAL_ENTITY_LINK_CREATED = entity_action(
    ENTITY_PERSON_LEGAL_ENTITY_LINK, ACTION_CREATED
)
ACTION_PERSON_LEGAL_ENTITY_LINK_DELETED = entity_action(
    ENTITY_PERSON_LEGAL_ENTITY_LINK, ACTION_DELETED
)

ACTION_AUTHORITY_CONTACT_CREATED = entity_action(ENTITY_AUTHORITY_CONTACT, ACTION_CREATED)
ACTION_AUTHORITY_CONTACT_UPDATED = entity_action(ENTITY_AUTHORITY_CONTACT, ACTION_UPDATED)
ACTION_AUTHORITY_CONTACT_DELETED = entity_action(ENTITY_AUTHORITY_CONTACT, ACTION_DELETED)

ACTION_ADVANCE_PAYMENT_CREATED = entity_action(ENTITY_ADVANCE_PAYMENT, ACTION_CREATED)
ACTION_ADVANCE_PAYMENT_UPDATED = entity_action(ENTITY_ADVANCE_PAYMENT, ACTION_UPDATED)
ACTION_ADVANCE_PAYMENT_STATUS_CHANGED = entity_action(ENTITY_ADVANCE_PAYMENT, ACTION_STATUS_CHANGED)
ACTION_ADVANCE_PAYMENT_DELETED = entity_action(ENTITY_ADVANCE_PAYMENT, ACTION_DELETED)
ACTION_ADVANCE_PAYMENT_AMENDED = entity_action(ENTITY_ADVANCE_PAYMENT, "amended")
ACTION_ADVANCE_PAYMENT_AMENDMENT_WITHDRAWN = entity_action(
    ENTITY_ADVANCE_PAYMENT, "amendment_withdrawn"
)
ACTION_ADVANCE_PAYMENT_TURNOVER_REFRESHED = entity_action(
    ENTITY_ADVANCE_PAYMENT, "turnover_refreshed"
)

ACTION_DOCUMENT_UPLOADED = entity_action(ENTITY_DOCUMENT, "uploaded")
ACTION_DOCUMENT_UPDATED = entity_action(ENTITY_DOCUMENT, ACTION_UPDATED)
ACTION_DOCUMENT_REPLACED = entity_action(ENTITY_DOCUMENT, "replaced")
ACTION_DOCUMENT_DELETED = entity_action(ENTITY_DOCUMENT, ACTION_DELETED)

ACTION_INVOICE_CREATED = entity_action(ENTITY_INVOICE, ACTION_CREATED)

ACTION_NOTE_CREATED = entity_action(ENTITY_NOTE, ACTION_CREATED)
ACTION_NOTE_UPDATED = entity_action(ENTITY_NOTE, ACTION_UPDATED)
ACTION_NOTE_DELETED = entity_action(ENTITY_NOTE, ACTION_DELETED)

ACTION_TASK_CREATED = entity_action(ENTITY_TASK, ACTION_CREATED)
ACTION_TASK_UPDATED = entity_action(ENTITY_TASK, ACTION_UPDATED)
ACTION_TASK_ASSIGNED = entity_action(ENTITY_TASK, "assigned")
ACTION_TASK_COMPLETED = entity_action(ENTITY_TASK, "completed")
ACTION_TASK_CANCELED = entity_action(ENTITY_TASK, "canceled")
ACTION_TASK_DELETED = entity_action(ENTITY_TASK, ACTION_DELETED)

ACTION_CORRESPONDENCE_CREATED = entity_action(ENTITY_CORRESPONDENCE, ACTION_CREATED)
ACTION_CORRESPONDENCE_UPDATED = entity_action(ENTITY_CORRESPONDENCE, ACTION_UPDATED)
ACTION_CORRESPONDENCE_DELETED = entity_action(ENTITY_CORRESPONDENCE, ACTION_DELETED)

ACTION_NOTIFICATION_SENT = entity_action(ENTITY_NOTIFICATION, "sent")

ACTION_REMINDER_CREATED = entity_action(ENTITY_REMINDER, ACTION_CREATED)
ACTION_REMINDER_CANCELED = entity_action(ENTITY_REMINDER, "canceled")
ACTION_REMINDER_FIRED = entity_action(ENTITY_REMINDER, "fired")
ACTION_REMINDER_FAILED = entity_action(ENTITY_REMINDER, "failed")

ACTION_TAX_CALENDAR_GENERATED = entity_action(ENTITY_TAX_CALENDAR, "generated")

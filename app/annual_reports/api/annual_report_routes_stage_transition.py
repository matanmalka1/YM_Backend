...
from app.annual_reports.api.annual_report_responses import REPORT_TRANSITION_RESPONSES
...
def transition_stage(
    report_id: PathId, body: StageTransitionRequest, db: DBSession, user: CurrentUser
):

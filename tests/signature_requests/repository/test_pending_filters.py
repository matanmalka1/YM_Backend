...
def test_pending_filter_by_client_record_id(test_db):
    repo = SignatureRequestRepository(test_db)
    user = _user(test_db)
    biz_a = _business(test_db, "001")
    biz_b = _business(test_db, "002")
...
def test_pending_filter_by_request_type(test_db):
    repo = SignatureRequestRepository(test_db)
    user = _user(test_db)
    biz = _business(test_db, "003")
...
def test_pending_filter_by_signer_email(test_db):
    repo = SignatureRequestRepository(test_db)
    user = _user(test_db)
    biz = _business(test_db, "004")
...
def test_pending_filter_by_expires_before(test_db):
    repo = SignatureRequestRepository(test_db)
    user = _user(test_db)
    biz = _business(test_db, "005")
...
def test_pending_filters_combined_with_and(test_db):
    repo = SignatureRequestRepository(test_db)
    user = _user(test_db)
    biz_a = _business(test_db, "006")
    biz_b = _business(test_db, "007")
...
def test_pending_no_match_returns_empty(test_db):
    repo = SignatureRequestRepository(test_db)
    user = _user(test_db)
    biz = _business(test_db, "008")
...
def test_pending_deterministic_tie_breaker(test_db):
    repo = SignatureRequestRepository(test_db)
    user = _user(test_db)
    biz = _business(test_db, "009")
